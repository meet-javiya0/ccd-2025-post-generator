    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            toast({
                ...
                description: "There was a problem generating your post. This might be due to a missing API key or a network issue. Please check your setup and try again.",
            });
        } finally {
            setIsLoading(false);
        }
                                                    ...
                                                    <FormControl>
                                                        <Tabs
                                                            ...
                                                            onValueChange={(value) => {
                                                                ...
                                                                form.clearErrors(); // Clear all errors when switching tabs
                                                            }}
                                                            className="w-full"
                                                        >
